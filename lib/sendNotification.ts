...
export async function createMsgIssueWithAttachment(text: string, attachments: Array<IMessageAttachment>,  read: IRead, modify: IModify, sender: IUser, room: IRoom): Promise<void> {
    modify.getNotifier().notifyUser(sender, modify.getCreator().startMessage({
        sender,
        room,
        text,
